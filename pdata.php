...
<ul class="list-group">
  ...
  <li class="list-group-item">
    <span class="badge bg-info float-right budge-own" ><?php echo $stotal;?></span> Total Price + Delivery Charges
  </li>
  <li class="list-group-item">
    <span class="badge bg-info float-right budge-own" ><?php echo $tax;?></span> Tax
  </li>
   <li class="list-group-item">
    <span class="badge bg-info float-right budge-own" ><?php echo $c['total'];?></span> Final Price
  </li>
  <li class="list-group-item">
